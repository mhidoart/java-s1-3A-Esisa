package com.esisa.jee.dao.jdbc;
...
public class Database {
	...
	public String[][] select(String tableName1, String tableName2) {
		String request = "SELECT * FROM " + tableName1 +","+ tableName2 + " WHERE "+tableName1+".id=" +tableName2+".idequipe";
